...
../.environment/bin/python3 val.py --weights ./runs/train/random_overlap_train4/weights/best.pt --img 1280 --data data_random_overlap.yaml --task train --name random_overlap_test