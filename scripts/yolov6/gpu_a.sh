...
../.environment/bin/python3 tools/eval.py --data ./data_random_overlap.yaml --verbose --do_pr_metric True --batch $batches --height 720 --width 1280 --task val --weights runs/train/l6_model1/weights/best_ckpt.pt --device 0 --name l6_model 
